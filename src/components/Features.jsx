    ...
    <section id="features" className="relative">
      <div className="mx-auto max-w-7xl px-6 py-24">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-gray-600">Craft engaging experiences, automate delivery, and prove impact—all in one platform.</p>
        </div>
        ...
        <div className="mt-16 grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="rounded-2xl border border-gray-200 p-6 bg-gradient-to-br from-white to-red-50">
            <h4 className="font-semibold">Adaptive Paths</h4>
            <p className="mt-2 text-sm text-gray-600">Auto-generate paths for new hires, managers, and ICs with skill checkpoints and nudges.</p>
          ...
          <div className="rounded-2xl border border-gray-200 p-6">
            ...
            <p className="mt-2 text-sm text-gray-600">Measure skills with quizzes, peer reviews, and practical tasks tied to performance.</p>
            <ul className="mt-4 space-y-2 text-sm text-gray-700 list-disc list-inside">
          ...
          <div className="rounded-2xl border border-gray-200 p-6">
            ...
            <p className="mt-2 text-sm text-gray-600">Dashboards for engagement, completion, and skill progression. Export to your data lake.</p>
            <ul className="mt-4 space-y-2 text-sm text-gray-700 list-disc list-inside">
